...
tap_dance_action_t tap_dance_actions[] = { // QMK 0.21から
    ...
    [MEDIA1] = ACTION_TAP_DANCE_DOUBLE(KC_MPLY, KC_MFFD),
    [MEDIA2] = ACTION_TAP_DANCE_DOUBLE(KC_MUTE, KC_MRWD),
    [MAC_LOCK] = ACTION_TAP_DANCE_DOUBLE(KC_LCTL, KC_F16), // Change Keycode w/ Karabiner
    [WIN_LOCK] = ACTION_TAP_DANCE_DOUBLE(KC_LCTL, LCA(KC_DEL))
};

// Keymap
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        KC_ESC,        TD(Q_ALTF4), TD(W_F2),   KC_E,         KC_R,           KC_T,                KC_Y,           KC_U,             KC_I,           KC_O,           KC_P,           KC_BSPC,
        LT(2,KC_TAB),  LT(2,KC_A),  KC_S,       KC_D,         KC_F,           KC_G,                KC_H,           KC_J,             KC_K,           KC_L,           KC_MINUS,       KC_ENT,
        LSFT_T(KC_F2), KC_Z,        KC_X,       KC_C,         KC_V,           KC_B,                KC_N,           KC_M,             KC_COMM,        KC_DOT,         KC_UP,          RSFT_T(KC_INT1),
        TD(MAC_LOCK),  KC_LALT,     KC_LGUI,    KC_LGUI,      KC_LGUI,        LT(3,KC_SPC),        LT(3,KC_SPC),   LT(3,KC_RGUI),    LT(3,KC_SLSH),  KC_LEFT,        KC_DOWN,        KC_RGHT
    ),
    [_WIN] = LAYOUT(
        TD(ESC_LCADEL),KC_TRNS,     KC_TRNS,    KC_TRNS,      KC_TRNS,        KC_TRNS,             KC_TRNS,        KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        KC_TRNS,       KC_TRNS,     KC_TRNS,    KC_TRNS,      KC_TRNS,        KC_TRNS,             KC_TRNS,        KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        KC_TRNS,       KC_TRNS,     KC_TRNS,    KC_TRNS,      KC_TRNS,        KC_TRNS,             KC_TRNS,        KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        KC_TRNS,       KC_LGUI,     KC_LALT,    KC_LALT,      LALT_T(JP_MHEN),KC_TRNS,             KC_TRNS,        RALT_T(JP_HENK),  KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS
    ),
    [_FUNC] = LAYOUT(
        ...
        KC_TRNS,       XXXXXXX,     XXXXXXX,    XXXXXXX,      XXXXXXX,        KC_PGDN,             KC_PGUP,        XXXXXXX,          KC_LBRC,        LCTL(KC_PGUP),  LCTL(KC_END),   LCTL(KC_PGDN)
    ),
    [_NUM] = LAYOUT(
        ...
        KC_TRNS,       XXXXXXX,     XXXXXXX,    XXXXXXX,      LCA(KC_DEL),    KC_PGDN,             KC_PGUP,        XXXXXXX,          XXXXXXX,        XXXXXXX,        KC_VOLD,        XXXXXXX
    )
};
